      ...
      <div className="calendar-head">
        ...
        <div className="calendar-controls">
          <div className="inline-meta">
            <button className="button-secondary" type="button" onClick={() => setAnchorDate(addDays(anchorDate, view === "day" ? -1 : -7))}>
              Vorige
            </button>
          ...
          <div className="inline-meta">
            <button className={`button-secondary ${view === "day" ? "active-toggle" : ""}`} type="button" onClick={() => setView("day")}>
              Dag
            </button>
            <button className={`button-secondary ${view === "week" ? "active-toggle" : ""}`} type="button" onClick={() => setView("week")}>
              Week
            </button>
          </div>
        </div>
